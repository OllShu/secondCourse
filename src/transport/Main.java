...
public class Main {
    public static void main(String[] args) {
        ...
        DriverWithLicenseC driverC4 = new DriverWithLicenseC("Соседов ПП", true, 12, true); //"Сачков СС", true, 13, true
        ...
        Car car1 = new Car("Lada", "Granta", 1.6, driverWithLicenseBS[0],
                List.of(mechanic1, mechanic2), CarBodyType.sedan);
        Car car2 = new Car("Audi", "A8 50 L TDI quattro", 3.0, driverWithLicenseBS[1],
                List.of(mechanic1, mechanic3), CarBodyType.sedan);
        Car car3 = new Car("BMW", "Z8", 3.0, driverWithLicenseBS[2],
                List.of(mechanic2, mechanic3), CarBodyType.sedan);
        Car car4 = new Car("Kia", "Sportage 4-го поколения", 2.0, driverWithLicenseBS[3],
                List.of(mechanic1, mechanic2, mechanic3), CarBodyType.crossover);
        Bus bus1 = new Bus("ПАЗ", "4234", 4.4, driverWithLicenseDS[0],
                List.of(mechanic1, mechanic3), BusCapacity.extraSmall);
        Bus bus2 = new Bus("Neoplan", "Skyliner", 10.5, driverWithLicenseDS[1],
                List.of(mechanic1, mechanic2), BusCapacity.extraLarge);
        Bus bus3 = new Bus("Volvo", "B10M", 14.9, driverWithLicenseDS[2],
                List.of(mechanic3), BusCapacity.large);
        Bus bus4 = new Bus("Mercedes-Benz", "O405G", 11.9, driverWithLicenseDS[3],
                List.of(mechanic1, mechanic2, mechanic3), BusCapacity.large);
        Truck truck1 = new Truck("КаМАЗ", "5490-S5", 12.0, driverWithLicenseCS[0],
                List.of(mechanic1), TruckCapacity.N1);
        Truck truck2 = new Truck("Scania", "DC16", 15.6, driverWithLicenseCS[1],
                List.of(mechanic2, mechanic3), TruckCapacity.N2);
        Truck truck3 = new Truck("MAN", "TGX", 12.4, driverWithLicenseCS[2],
                List.of(mechanic2), TruckCapacity.N2);
        Truck truck4 = new Truck("Volvo", "D8K", 7.7, driverWithLicenseCS[3],
